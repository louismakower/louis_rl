"""Reward normaliser based on the variance of discounted returns.

Adapted from: https://github.com/[FlashSAC_dex]/flash_rl/utils.py
"""
...
class RewardNormalizer:
    ...
    regimes where the std-only denominator would be near zero.
